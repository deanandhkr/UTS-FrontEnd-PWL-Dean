      ...
      <>
        <table className="table table-hover mb-3 cart-table">
          <thead>
            <tr>
              <th>Produk</th>
              <th className="text-center">Jumlah Produk</th>
        ...
        <div className="col-md-12 cart d-flex justify-content-center">
          <div className="col-md-6 p-4 border alert alert-secondary">
            <div className="d-flex gst">
              <div className="flex-grow-1">Biaya Layanan</div>$
              {parseFloat(tax).toFixed(2)}
            </div>
            <hr />
            <div className="d-flex gst">
              <div className="flex-grow-1">Subtotal untuk Produk</div>$
    ...
    showCart = (
      <div className="w-100">
        ...
        <p className="text-center">
          Yuk, lanjutkan pilih barang belanjamu di BroBroDean
        </p>
